                    ...
                    <div className="col-12 col-md-9">
                        <Form>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="lastname" name="lastname" placeholder="First Name" value={this.state.lastname} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                <Col md={{ size: 6, offset: 2 }}>
                                    <FormGroup check>
                                        <Label check>
                                            <Input type="checkbox" id="agree" checked="this.state.agree">
                                            {"May we contact you?"}
                                            </Input>
                                        </Label>
                                    </FormGroup>
                                ...
                                <Col md={{ size: 3, offset: 1 }}>
                                    <Input type="select" name="contatType" value={this.state.contactType}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Input>
                                </Col>
